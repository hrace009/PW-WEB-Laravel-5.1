...
Breadcrumbs::register('admin.news.edit', function ($breadcrumbs, Article $article) {
    $breadcrumbs->parent('admin.news');
...
Breadcrumbs::register('admin.shop.edit', function ($breadcrumbs, ShopItem $item) {
    $breadcrumbs->parent('admin.shop');
...
Breadcrumbs::register('admin.voucher.edit', function ($breadcrumbs, Voucher $voucher) {
    $breadcrumbs->parent('admin.voucher');
...
Breadcrumbs::register('admin.vote.edit', function ($breadcrumbs, VoteSite $site) {
    $breadcrumbs->parent('admin.vote');
