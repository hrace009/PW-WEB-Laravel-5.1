            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input name="server_name" type="text" class="form-control" id="server_name"
                           placeholder="{{ trans( 'system.server_name' ) }}" value="{{ settings( 'server_name' ) }}">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input name="server_ip" type="text" class="form-control" id="server_ip"
                           placeholder="{{ trans( 'system.server_ip' ) }}" value="{{ settings( 'server_ip' ) }}">
                    <div class="form-control-focus"></div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <select name="server_version" class="form-control" id="version">
                        ...
                        <option value="101" {{ settings( 'server_version' ) == '101' ? 'selected' : NULL }}>v101
                        </option>
                    </select>
