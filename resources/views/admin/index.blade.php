                            ...
                            <div class="details">
                                <div class="number">
                                    <span data-counter="counterup"
                                          data-value="{{ $api->online ? count( $api->getOnlineList() ) : 0 }}">0</span>
                                </div>
                    ...
                    <div class="col-md-6 mb-md">
                        <div class="dashboard-stat purple">
                            ...
                            <div class="details">
                                <div class="number">
                                    <span data-counter="counterup"
                                          data-value="{{ DB::table('point')->count() }}">0</span>
                                </div>
                    ...
                    <div class="col-md-6 mb-md">
                        <div class="dashboard-stat yellow-gold">
                            ...
                            <div class="details">
                                <div class="number">
                                    <span data-counter="counterup"
                                          data-value="{{ DB::table('pweb_ranking_players')->count() }}">0</span>
                                </div>
                    ...
                    <div class="col-md-6 mb-md">
                        <div class="dashboard-stat green">
                            ...
                            <div class="details">
                                <div class="number">
                                    <span data-counter="counterup"
                                          data-value="{{ DB::table('pweb_ranking_factions')->count() }}">0</span>
                                </div>
