                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#vote_sites"
                                   href="#site_{{ $site->id }}"> <span
                                            id="name">{{ $site->name }}</span> {!! $site->double_rewards ? "<span class=\"label label-primary font-white\"> " . trans( 'vote.double_rewards' ) . "</span>" : NULL !!}
                                </a>
                            </h4>
                        </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-center fs20">
                                    <a class="font-green tooltips mr-md" data-placement="top"
                                       ...
                                       href="{{ route( 'admin.vote.edit', $site->id ) }}"><i
                                                class="icon-pencil"></i></a>
                                    <a class="font-red tooltips delete" data-placement="top"
                                       data-original-title="{{ trans( 'main.remove' ) }}"
                                       href="{{ route( 'admin.vote.destroy', $site->id ) }}"><i class="icon-trash"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
