...
@section( 'content' )
    <div class="note note-info">
        ...
        <p> RankTheServer (RTS) is a newer toplist website, you can create a free account and create a site in minutes!
            <a href="http://ranktheserver.com/auth/login">Click here to register!</a>
        </p>
    </div>
