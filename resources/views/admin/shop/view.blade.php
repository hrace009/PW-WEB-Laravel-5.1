                ...
                <div class="grid-item box bg-white">
                    ...
                    <div class="caption mt-xs p-sm">
                        ...
                        <div class="scroller" style="height:100px" data-always-visible="1" data-rail-visible="1"
                             data-rail-color="#111" data-handle-color="#000">
                            {!! $item->description !!}
                        </div>
                        <div class="grid-item-buy text-center mt-md">
                            <div class="text-center fs20">
                                <a class="font-green tooltips mr-md" data-placement="top"
                                   ...
                                   href="{{ route( 'admin.shop.edit', $item->id ) }}"><i class="icon-pencil"></i></a>
                                <a class="font-red tooltips delete" data-placement="top"
                                   data-original-title="{{ trans( 'main.remove' ) }}"
                                   href="{{ route( 'admin.shop.destroy', $item->id ) }}"><i class="icon-trash"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
