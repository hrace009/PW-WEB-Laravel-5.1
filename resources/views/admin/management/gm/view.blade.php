                    ...
                    <table class="table">
                        ...
                        @foreach( $gms as $gm )
                            <tr>
                                ...
                                <td>
                                    <div class="fs20">
                                        <a class="font-blue tooltips mr-md" data-placement="top"
                                           data-original-title="{{ trans( 'management.change_permissions' ) }}"
                                           href="{{ url( 'admin/management/gm/edit/' . $gm->userid ) }}"><i
                                                    class="icon-settings"></i></a>
                                        <a class="font-red tooltips" data-placement="top"
                                           data-original-title="{{ trans( 'main.remove' ) }}"
                                           href="{{ url( 'admin/management/gm/remove/' . $gm->userid ) }}"><i
