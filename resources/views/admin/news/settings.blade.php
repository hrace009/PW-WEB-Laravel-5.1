                ...
                <div class="form-body">
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label"
                               for="articles_per_page">{{ trans( 'news.articles_per_page' ) }}</label>
                        <div class="col-md-9">
                            <input name="articles_per_page" type="number" class="form-control" id="articles_per_page"
                                   value="{{ settings( 'news_items_per_page' ) }}">
