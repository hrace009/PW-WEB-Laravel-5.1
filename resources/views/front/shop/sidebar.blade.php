<div class="col-md-3 mb-md">
    <div class="mt-element-list">
        <div class="mt-list-container list-simple ext-1 group">
            ...
            <div class="panel-collapse collapse {{ array_key_exists( Request::segment( 3 ), trans( 'shop.masks.armor' ) ) ? 'in' : NULL }}"
                 id="equipment">
                <ul>
            ...
            <div class="panel-collapse collapse {{ array_key_exists( Request::segment( 3 ), trans( 'shop.masks.fashion' ) ) ? 'in' : NULL }}"
                 id="fashion">
                <ul>
            ...
            <div class="panel-collapse collapse {{ array_key_exists( Request::segment( 3 ), trans( 'shop.masks.accessories' ) ) ? 'in' : NULL }}"
                 id="accessories">
                <ul>
            ...
            <div class="panel-collapse collapse {{ array_key_exists( Request::segment( 3 ), trans( 'shop.masks.charms' ) ) ? 'in' : NULL }}"
                 id="charms">
                <ul>
