...
<div class="page-header">
    <div class="page-header-top">
        <div class="container">
            <div class="page-logo">
                <a class="logo-default navbar-brand uppercase font-dark"
                   href="{{ url( '/' ) }}">{{ settings( 'server_name', 'Perfect World Panel' ) }}</a>
            </div>
                        ...
                        <li class="dropdown dropdown-dark">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                               data-close-others="true">
                                @if ( !$agent->isMobile() )
                                    <img class="avatar"
                                         src="{{ Avatar::create( strtoupper( Auth::user()->name ) )->toBase64() }}"/>
                                @endif
