...
!function ($) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function checkVal(input, writeOut, strict, nptvl) {
            ...
            var inputValue = void 0 !== nptvl ? nptvl.slice() : input.inputmask._valueGet().split(""), charCodes = "",
                initialNdx = 0;
        ...
        var undoValue, compositionCaretPos, compositionData, el, $el, maxLength, valueBuffer, isRTL = !1,
            skipKeyPressEvent = !1, skipInputEvent = !1, ignorable = !1, mouseEnter = !0;
